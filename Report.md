...
* Program should support user input
...
* Power from the 3.3V pin
* Ground from the GND pin
* Servo for second incrementation uses A1, which is pin 26 on the ESP board
* Servo for minute incrementation uses A0, which is pin 25 on the ESP board
* Alphanumeric display uses M0, M1, SCL, and SDA on the ESP board, which are pins 18, 19, 22, and 23 respectively. 
* The LEDs uses A11 and A12, which are pins 12 and 27 respectively. 
